...
class Vector:
    ...
    def getLength(vector1, vector2):
        length = 0
        if vector2.value[14] != 'М':
            length = length + 1
        if vector2.value[16] != 'Н':
            length = length + 1
        if vector2.value[18] != 'Ф':
            length = length + 1
        if vector2.value[19] != 'Е':
            length = length + 1       
        if vector2.value[20] != 'С':
            length = length + 1
        if vector2.value[21] != 'Т':
            length = length + 1
        if vector2.value[9] != 'Ц':
            length = length + 1
        if vector2.value[13] != 'Я':
            length = length + 1
        return length
